...
read_chunk( path="/media/audrey/data/galaxy/tools/newTools/Deseq2_Report/data_quality_galaxy.R")
read_chunk( path="/media/audrey/data/galaxy/tools/newTools/Deseq2_Report/diffexp_galaxy.R")
```
